...
medBIDSDataInfoWidget::medBIDSDataInfoWidget(QMap<QString, QString> dataAttributes, QMultiMap<QString, QString> optionalAttributes, QWidget *parent) : QDialog(parent)
{
...
medBIDSDataInfoWidget::~medBIDSDataInfoWidget()
{
}
